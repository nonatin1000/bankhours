"""
Django settings for bankhours project.
...
SECRET_KEY = '*tsr-jtdp^vwf2yrojpv3^7l%zojq5^l)f43y2gx!4a-2^urm9'
...
WSGI_APPLICATION = 'bankhours.wsgi.application'
